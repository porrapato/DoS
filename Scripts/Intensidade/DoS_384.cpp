// DoS_384.cpp
// Arquivo de ataque DoS, com 50% de usuários maliciosos, requisitando 384 pacotes por segundo.
...
main(int argc, char* argv[])
{
  ...
  for (int i = 9; i < 18; i++) {
    ndn::AppHelper consumerHelper("ns3::ndn::ConsumerCbr");
    consumerHelper.SetAttribute("Frequency", StringValue("384")); // 512 interests a second
