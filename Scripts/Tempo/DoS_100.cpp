// DoS_100.cpp
// Arquivo de ataque DoS, com 50% de usuários maliciosos, duração do ataque de 90s.
...
main(int argc, char* argv[])
{
  ...
  for (int i = 0; i < 9; i++) {
    ...
    consumer.Stop(Seconds(90 - i/2)); // stop consumers at 25s, 26s, 27s, 28s, 29s and 30s
  }
  ...
  for (int i = 9; i < 18; i++) {
    ...
    consumer.Stop(Seconds(90 - i/4)); // stop consumers at 27s, 28s, 29s and 30s
  }
